...
export default function page() {
  return (
    <main className=" min-h-screen flex flex-col items-center justify-center w-full  ">
      ...
      <div className='container    sm:flex-row gap-4 py-24 mt-12   bg-slate-200 flex-1  grid  md:grid-flow-col md:grid-rows-3 md:grid-cols-3  grid-flow-row  grid-rows-1 grid-cols-1 md:rounded-lg'>
